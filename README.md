...
This is a repository for Build a SaaS AI Platform with Next.js 13, React, Tailwind, Prisma, Stripe | Full Tutorial 2023. By PHANTOMGOD
...
```shell
git clone https://github.com/PHANTOMGOD2OP/INFINITY-AI.git
```
